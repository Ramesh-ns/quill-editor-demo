package com.factly.quill.editor.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.factly.quill.editor.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.factly.quill.editor.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
